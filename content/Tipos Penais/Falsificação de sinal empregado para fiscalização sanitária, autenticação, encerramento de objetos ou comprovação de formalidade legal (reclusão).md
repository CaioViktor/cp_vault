---
id: "CP_306_PU_RECLUSAO"
nome: "Falsificação de sinal empregado para fiscalização sanitária, autenticação, encerramento de objetos ou comprovação de formalidade legal (reclusão)"
entidade: "TIPO_PENAL"
artigo: "306"
paragrafo: "unico"
inciso: null
...
aliases: ["CP_306_PU_RECLUSAO"]
tags: ["kg/tipo-penal", "kg/modalidade/derivado"]
---

# Falsificação de sinal empregado para fiscalização sanitária, autenticação, encerramento de objetos ou comprovação de formalidade legal (reclusão)

**ID:** `CP_306_PU_RECLUSAO`

**Dispositivo:** Art. 306, parágrafo único
...
**DERIVA_DE:** [[Falsificar, fabricando-o ou alterando-o, marca ou sinal empregado pelo poder público no contraste de metal precioso ou na fiscalização alfandegária...]]
